      ...
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Aquí gestionas lo que ve el usuario en la página pública <code>/realities</code>.
            Los usuarios solo ven contenido <strong>Publicado</strong>.
          </p>
        </div>
              ...
              <CardContent>
                ...
                {list.length > 6 && (
                  <p className="text-xs text-muted-foreground mt-3">
                    Mostrando 6 de {list.length}. Para ver/editar todos: “Abrir editor de contenidos”.
                  </p>
                )}
              </CardContent>
            </Card>
